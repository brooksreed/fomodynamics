...
Detailed reference docs live under `docs/`:
...
- `frame_conventions.md` — NED/FRD frames, scalar-first quaternions.
...
- `guides/getting_familiar/` — tutorial series paired with the
  notebooks under `notebooks/getting_familiar/`.
