...
| Bridge | JAX vs NumPy equivalence | [`test_bridge.py`](https://github.com/brooksreed/fomodynamics/blob/main/tests/simulator/jax/test_bridge.py) |
...
**Configuration** (from [`test_notebooks.py`](https://github.com/brooksreed/fomodynamics/blob/main/tests/test_notebooks.py)):
...
See [`tests/simulator/jax/conftest.py`](https://github.com/brooksreed/fomodynamics/blob/main/tests/simulator/jax/conftest.py) for tolerance constants.
