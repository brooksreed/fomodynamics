...
def _compute_euler_from_quaternion(states: np.ndarray, state_names: list[str]) -> dict[str, np.ndarray]:
    ...
    # fmd.simulator.quaternion) because states are already converted to numpy at this point.
...
def result_to_datastream(
    ...
    This provides tight integration between fmd.simulator and fmd.analysis,
