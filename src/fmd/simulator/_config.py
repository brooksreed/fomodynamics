"""JAX configuration for fmd.simulator.

This module ensures JAX is configured correctly for fmd.simulator.
Configuration is now centralized in fmd.core.jax_config.

Usage:
    import fmd.simulator._config  # Side-effect import enables float64 and GPU

    # Use consistent dtype
    from fmd.simulator._config import FMD_DTYPE
