...
Note: The blur.simulator package uses JAX (jax.numpy) for JIT compilation
and autodiff. This module remains numpy-only for use in blur.core and
...
def quat_normalize(q: ArrayLike) -> NDArray:
    ...
    This matches the JAX implementation in blur.simulator.quaternion.
